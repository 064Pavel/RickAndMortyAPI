...
class LocationController extends AbstractController
{
    ...
    public function __construct(LocationService $locationService, SerializerInterface $serializer, ValidatorInterface $validator)
    {
    ...
    #[Route('/api/v1/location', name: 'all.location', methods: 'GET')]
    ...
    #[Route('/api/v1/location/{id}', name: 'get.location', methods: 'GET')]
    ...
    #[Route('/api/v1/location', name: 'create.location', methods: 'POST')]
    ...
    #[Route('/api/v1/location/{id}', name: 'update.location', methods: ['PUT', 'PATCH'])]
    ...
    #[Route('/api/v1/location/{id}', name: 'delete.location', methods: 'DELETE')]
